export default {
  ...
  main: {
    ...
    checkingSession: "Check Session...",
    loadingInstances: "Loading Instance...",
  ...
  settings: {
    ...
    onLaunchBehavior: "On Game Launch",
    onLaunchTray: "Minimize to Tray (Recommended)",
    onLaunchMinimize: "Minimize Window",
    onLaunchQuit: "Exit Launcher",
    onLaunchKeep: "Keep Launcher Open",
