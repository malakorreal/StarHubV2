...
function AchievementsView() {
    ...
    return (
        <div style={{ padding: '20px', animation: 'fadeIn 0.3s', position: 'relative', height: '480px', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            {loading ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', flex: 1, overflow: 'hidden' }}>
                    ...
                    <div className="achievements-grid" style={{ 
                        ...
                        borderRadius: '12px',
                        maxHeight: 'calc(100% - 110px)' // Reserve space for detail panel
                    }}>
                        {achievements.map(ach => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div style={{ fontSize: '1.8em', transition: 'transform 0.2s' }}>
                                        {ach.image ? (
                                            <img src={ach.image} style={{ width: '36px', height: '36px', objectFit: 'contain' }} alt={ach.title} />
                                        ) : (
                                            ach.icon || '🏆'
                                        )}
                                    </div>
                    ...
                    {/* Achievement Details Panel - Fixed at bottom */}
                    <div style={{ 
                        padding: '15px', 
                        ...
                        {selectedAch ? (
                            <>
                                <div style={{ 
                                    ...
                                    fontSize: '1.4em', border: `1px solid ${selectedAch.color}30`
                                }}>
                                    {selectedAch.image ? <img src={selectedAch.image} style={{ width: '28px' }} /> : selectedAch.icon}
                                </div>
                                <div style={{ flex: 1 }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '2px' }}>
                                        <h4 style={{ margin: 0, color: '#fff', fontSize: '0.95em' }}>{selectedAch.title}</h4>
                                    ...
                                    <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: '0.75em', lineHeight: '1.4' }}>
                            ...
                            <div style={{ color: 'var(--text-secondary)', fontStyle: 'italic', fontSize: '0.8em', textAlign: 'center', width: '100%' }}>
